...
class BcolzArrayIterator(object):
    ...
    def __init__(self, X, y=None, image_data_generator=None, w=None, batch_size=32, shuffle=False, seed=None):
        ...
        assert(image_data_generator is not None)
    ...
    def next(self):
        with self.lock:
            ...
            #batch_x = np.array(batches_x)
            batch_x = np.array([self.image_data_generator.standardize(
